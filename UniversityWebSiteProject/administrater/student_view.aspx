...
<div align="right">
        ...
        <asp:Button ID="find" runat="server" onclick="find_Click" Text="Find" 
            BackColor="#520108" BorderStyle="Solid" BorderWidth="1px" Font-Bold="True" 
            ForeColor="White" /></div>
    <div style="height:400px; overflow:scroll; width: 823px;" align="left">
      <table class="style1">
            <tr>
                <td class="style4" 
                    style="color: #FFFFFF; font-weight: bold; background-color: #520108">
                    IDNO</td>
                <td class="style5" 
                    style="color: #FFFFFF; font-weight: bold; background-color: #520108">
                    NAME</td>
                ...
                <td class="style6" 
                    style="color: #FFFFFF; font-weight: bold; background-color: #520108">
                    MOBILE</td>
                <td style="color: #FFFFFF; font-weight: bold; background-color: #520108">
                    ACTION</td>
            </tr>
        </table>
&nbsp;
...
<asp:TableCell ID="cell" runat="server" BorderStyle="Solid" BorderWidth="2"  CssClass="style7"> 
    ...
    <div>
        <asp:Button ID="Button1" runat="server" BackColor="White" BorderColor="#520108" 
            BorderStyle="Solid" BorderWidth="1px" Font-Bold="True" ForeColor="#520108" 
